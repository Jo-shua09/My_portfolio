...
!(function (t) {
  ...
  !(function () {
    ...
    n.extend(e.Mixer.prototype, {
      ...
      getinternixData: function (t) {
        var e = this,
          n = null,
          a = -1;
        for (
          e.callActions("beforeGetinternixData", arguments), a = 0;
          (n = t.show[a]);
          a++
        )
        ...
        e.callActions("afterGetinternixData", arguments);
      },
      setFinal: function (t) {
        var e = this,
          n = null,
      ...
      hasEffect: function () {
        ...
        if (1 !== t.effectsIn.opacity)
          return t.callFilters("resulthansEffect", !0, arguments);
        for (r = 0; (n = e[r]); r++)
          if (
            ((a = t.effectsIn[n]),
        ...
        return t.callFilters("resulthansEffect", i, arguments);
      },
